      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-14">
          ...
          <div className="flex items-center space-x-2">
            ...
            <ThemeToggle />
            <LanguageToggle />
            <span className="text-xs font-medium text-gray-700 dark:text-gray-300 px-2 py-1 rounded bg-gray-100 dark:bg-gray-800">
              {userName}
            </span>
            <form action={signOut}>
              <Button type="submit" variant="outline" size="sm" className="hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-600 dark:hover:text-red-400 hover:border-red-300 dark:hover:border-red-700 text-xs">
                Çıkış
              </Button>
            </form>
          </div>
